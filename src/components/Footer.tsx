    ...
    <footer className="bg-[#070707] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                <span className="text-[#F33E7B] shrink-0">✉️</span>
                <a href="mailto:Khurram@launchtok.shop" className="text-[#b1b1b1] font-medium hover:text-[#25f4ee] transition">
          ...
          {/* Social Connect (Text Links Only) */}
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="text-[#b1b1b1] hover:text-[#25f4ee] transition font-medium"
                >
                  Facebook
                </a>
              </li>
              <li>
                <a
                  href="www.linkedin.com/in/khurram-mohammad-aali-2a5123345"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#b1b1b1] hover:text-[#25f4ee] transition font-medium"
                >
              ...
              <li>
                <a
                  href="https://www.fiverr.com/s/wkxzG9D"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#b1b1b1] hover:text-[#25f4ee] transition font-medium"
                >
        ...
        {/* Bottom Bar matching image layout */}
        <div className="border-t border-white/5 pt-8">
          <p className="text-[#555555] text-sm font-medium">
            Copyright ©2025, Tiktok Launch All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
